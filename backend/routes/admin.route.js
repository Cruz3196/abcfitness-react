...
router.get('/trainers/pending-profiles', protectRoute, authorize("admin"), pendingTrainerProfiles); // viewing pending trainer profiles
...
router.put('/users/:userId/statusChange', protectRoute, authorize("admin"), changeUserStatus);

// getting the dasboard statistics
router.get('/dashboard/stats', protectRoute, authorize("admin"), getDashboardStats);
