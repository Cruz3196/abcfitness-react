...
const ProductForm = ({ onClose, categories = [] }) => {
  const { createProduct, isLoading } = productStore();
            ...
            <div className="border-2 border-dashed border-base-300 rounded-lg p-4 text-center">
              {!previewUrl ? (
                <div className="flex flex-col items-center">
                  ...
                  />
                  <label htmlFor="product-image" className="btn btn-sm btn-outline">
              ...
              {errors.productImage && (
                <span className="text-error text-xs mt-1 block">{errors.productImage}</span>
              )}
            </div>
          </div>
